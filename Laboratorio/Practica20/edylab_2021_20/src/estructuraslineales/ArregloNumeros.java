...
public class ArregloNumeros extends ArregloDatos{
    ...
    /**
     * Sobrescribe la varible lote con la pasada como parametro
     * @param buffer nuevo valor de lote
     */
    public void ingresarAudio(double[] buffer){
    ...
    public double[] leerArreglo(){
        ...
        for(int posicion=0;posicion<cantidadElementos();posicion++){
            copia[posicion] = (double)obtener(posicion);
        }
        return copia;
    }
}
