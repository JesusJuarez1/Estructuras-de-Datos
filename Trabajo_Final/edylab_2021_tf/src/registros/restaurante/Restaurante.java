...
public class Restaurante implements IRestaurante{
    ...
    private void iniciar(){
        ...
        tacos.agregar(new Ingrediente("Tortilla","Tortilla de maiz",25,TipoIngrediente.SOLIDO));
        tacos.agregar(new Ingrediente("Carne al pastor","Carne tipo al pastor",50,TipoIngrediente.SOLIDO));
        comidas.agregar(new Comida("Tacos al pastor","Dorar carne",new Cocinero("Juan"),TipoComida.CARNIVORA,tacos));
        ...
        torta.agregar(new Ingrediente("Carnitas","Carnitas de puerco doraditas",75,
                TipoIngrediente.SOLIDO));
        comidas.agregar(new Comida("Torta","Dorar carnitas",new Cocinero("Pedro"),TipoComida.CARNIVORA,torta));
